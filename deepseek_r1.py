...
beginner_question_chain = beginner_question_prompt | llm | remove_thoughts


easy_question_chain = easy_question_prompt | llm | remove_thoughts


medium_question_chain = medium_question_prompt | llm | remove_thoughts


hard_question_chain = hard_question_prompt | llm | remove_thoughts


answer_chain = answer_prompt | llm | remove_thoughts



get_question_data_chain = get_question_data_prompt | llm | remove_thoughts

feedback_chain = feedback_prompt | llm | remove_thoughts


rating_chain = rating_prompt | llm | remove_thoughts